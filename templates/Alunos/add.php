        ...
        <div class="alunos form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    echo $this->Form->control('ingresso', ['label' => 'Período de Ingresso (ex: 2022-1)', 'pattern' => '[0-9]{4}\-[1-2]', 'title' => 'Formato: 0000-0', 'placeholder' => '2022-1', 'required' => true]);
                    echo $this->Form->control('turno', ['options' => ['diurno' => 'Diurno', 'noturno' => 'Noturno', 'indefinido' => 'Indefinido'], 'empty' => true, 'required' => true]);
                    echo $this->Form->control('cep', ['label' => 'CEP', 'pattern' => '[0-9]{5}\-[0-9]{3}', 'title' => 'Formato: 00000-000', 'required' => true]);
