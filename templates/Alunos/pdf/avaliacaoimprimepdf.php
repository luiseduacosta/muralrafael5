...
Supervisor(a) de Campo: <?= $supervisor ?? '_______________________'; ?> CRESS: <?= $cress ?? '_____'; ?><br />
E-mail: <?= $email ?? '_______________________'; ?> Telefone: <?= $telefone ?? '_______________________'; ?> Celular: <?= $celular ?? '_______________________'; ?><br />
Campo de Estágio: <?= $instituicao; ?><br />
Endereço Institucional: <?= $endereco_inst ?? '_______________________'; ?><br />
Período de realização do estágio: <?= $periodo; ?><br />
Nível de Estágio: <?= $nivel; ?><br />
Supervisor(a) Acadêmico(a): <?= $professor ?? '_______________________'; ?>
</p>
