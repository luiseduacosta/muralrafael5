...
CREATE TABLE IF NOT EXISTS `professores` (
  ...
  `codigo_telefone` int(2) NOT NULL DEFAULT 21,
  `telefone` varchar(15) DEFAULT NULL,
  `codigo_celular` int(2) NOT NULL DEFAULT 21,
  `celular` varchar(15) DEFAULT NULL,
  ...
  `user_id` int(11) NOT NULL, 
  `estagiarios_count` int(10) DEFAULT NULL,
  `status` varchar(10) DEFAULT 'ativo' COMMENT 'Status do professor: "ativo", "inativo"',
...
CREATE TABLE IF NOT EXISTS `supervisores` (
  ...
  `email` varchar(50) DEFAULT NULL,
  `codigo_telefone` int(2) DEFAULT NULL DEFAULT 21,
  `telefone` varchar(15) DEFAULT NULL,
  `codigo_celular` int(2) DEFAULT NULL DEFAULT 21,
  `celular` varchar(15) DEFAULT NULL,
