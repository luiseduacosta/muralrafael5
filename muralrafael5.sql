...
CREATE TABLE IF NOT EXISTS `alunos` (
  ...
  `turno` varchar(7) DEFAULT NULL  COMMENT 'd=Diurno, n=Noturno, i=Indefinido',
...
CREATE TABLE IF NOT EXISTS `instituicoes` (
  ...
  `beneficio` varchar(50) DEFAULT NULL COMMENT 'Benefícios oferecido pela instituição',
  ...
  `convenio` int(4) DEFAULT NULL COMMENT 'Código do convênio na UFRJ',
...
CREATE TABLE IF NOT EXISTS `mural_estagio` (
  ...
  `dataInscricao` date DEFAULT NULL COMMENT 'Data limite de encerramento das inscrições no mural',
  `horarioSelecao` varchar(5) DEFAULT NULL,
  `localSelecao` varchar(70) DEFAULT NULL,
  `formaSelecao` char(1) DEFAULT NULL COMMENT '0=Entrevista, 1=CR, 2=Prova, 3=Outra',
...
CREATE TABLE IF NOT EXISTS `supervisores` (
  ...
  `outros_estudos` varchar(100) DEFAULT NULL COMMENT 'Outros estudos do supervisor',
  `area_curso` varchar(40) DEFAULT NULL COMMENT 'Área de curso do supervisor',
  `ano_curso` varchar(4) DEFAULT NULL COMMENT 'Ano de curso do supervisor',
